...
public final class AnnotatedDelegatingCombiner<K1, V1, K2, V2> extends Reducer<K1,V1,K2,V2>
	implements AnnotatedDelegatingComponent<Reducer<K1,V1,K2,V2>> {

	public static final String CONFKEY_DELEGATE_COMBINER_CLASS = AnnotatedDelegatingCombiner.class.getName() + ";delegate";
