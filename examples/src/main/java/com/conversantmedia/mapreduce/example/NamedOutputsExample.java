...
@Driver("namedOutputsExample")
public class NamedOutputsExample {

	@JobInfo("Demonstration of named outputs via annotation")
	@MapperInfo(NamedOutputWordCountMapper.class)
